...
from model_scripts_old.agent_hierarchical_heuristic import ConstantHA
...
def main():
    ...
    env = RFPOperationalEnv(rfp=rfp, forecaster=forecaster, decision_horizon=decision_horizon)

    """ Set experiment indicator """
    experiment_name = "testConstant"
    print("Start experiment: ", experiment_name)
    agent = ConstantHA(env=env)
...
if __name__ == '__main__':
    cProfile.run("main()", "run_profiles/runRandom.prof")