...
from model_scripts_old.RFP_operational_environment import RFPOperationalEnv, ShieldRRPEnv
from model_scripts_old.agent_hierarchical_heuristic import DeterministicHA
...
def main():
    ...
    agent = DeterministicHA(env=env, guideline=guideline, solver='gurobi_persistent')
...
if __name__ == '__main__':
    cProfile.run("main()", "run_profiles/run_Deterministic.prof")