...
def main():
    ...
    env = SpotBuyRFPEnv(rfp=rfp, forecaster=forecaster, decision_horizon=decision_horizon, planning_horizon=planning_horizon, normalize=True)
    s, info = env.reset()
    ...
    warmstarting_agent = warmstart_agent(env, warmstarting_agent, spotbuy=True)
...
if __name__ == '__main__':
    cProfile.run("main()", "run_profiles/run_RLSpotBuy.prof")