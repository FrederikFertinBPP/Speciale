...
from model_scripts_old.agent_hierarchical_heuristic import SpotBuyDeterministicHA
...
def main():
    ...
    experiment = "testDeterministicSpotbuy_"
    ...
    agent = SpotBuyDeterministicHA(env=env, guideline=guideline, solver='gurobi_persistent')
