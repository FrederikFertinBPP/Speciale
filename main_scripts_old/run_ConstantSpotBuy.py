...
from model_scripts_old.agent_hierarchical_heuristic import SpotBuyConstantHA
...
def main():
    ...
    agent = SpotBuyConstantHA(env=env)
...
if __name__ == '__main__':
    cProfile.run("main()", "run_profiles/runConstantSpotBuy.prof")