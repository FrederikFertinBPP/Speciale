...
if __name__ == '__main__':
    ...
    ppa_prices = pd.read_csv(f"{results_folder}/ppa_prices-chosen.csv")
    ...
    experiments = ("backcasting_AggregateFullHorizonAgent_ph_96_spot_True_out_of_sample",
                   "SOTA1year_AggregateFullHorizonAgent_ph_96_spot_True_out_of_sample",
    ...
    for scenario in scenarios:
        rfp = create_rfp(scenario_name=str(scenario), layout_file=layout_file)
        ...
        opt_models = []
        for exp_ix, experiment in enumerate(experiments):
            experiment_name = experiment + "_" + str(scenario)
